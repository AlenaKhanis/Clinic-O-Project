...
VALUES 
    ('Alona', '1234', 'alona@mysite.com', 30, 'Alona Khanis', '05462224455', 'owner', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('user', '1234', 'user@mysite.com', 25, 'user', '456445', 'patient', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('doctor', '5454', 'doctor@mysite.com', 45, 'doctor', '555', 'doctor', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
